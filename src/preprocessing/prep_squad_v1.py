...
def pre_process(args):
    ...
    save_as_json(args, args.word2idx_file, word2idx_dict, message="word dictionary")
    save_as_json(args, args.char2idx_file, char2idx_dict, message="char dictionary")
...
if __name__ == '__main__':
    ...
    args_.glove_file = glove_dir.joinpath(os.path.basename(glove_dir) + glove_ext)
